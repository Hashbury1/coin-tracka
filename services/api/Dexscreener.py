            ...
            normalized.append(
                {
                    ...
                    # The token's own contract/mint address, distinct from
                    # pairAddress (the LP pair) above. Needed for holder
                    # concentration lookups (Birdeye/Moralis), which query
                    # the token contract, not the trading pair.
